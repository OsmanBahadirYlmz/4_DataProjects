...
void setup(){
  ...
  tmrpcm.play("a1.wav"); //the sound file "music" will play each time the arduino powers up, or is reset
  tmrpcm.play("a2.wav"); //the sound file "music" will play each time the arduino powers up, or is reset
  tmrpcm.play("a3.wav"); //the sound file "music" will play each time the arduino powers up, or is reset
  tmrpcm.play("gelecek4.wav"); //the sound file "music" will play each time the arduino powers up, or is reset
  tmrpcm.play("gelecek2.wav"); //the sound file "music" will play each time the arduino powers up, or is reset
  tmrpcm.play("gelecek2.wav"); //the sound file "music" will play each time the arduino powers up, or is reset
