# -*- coding: utf-8 -*-
"""
Created on Fri Dec 26 19:57:32 2021

@author: Muhammed CAGLAR
"""
...
def training(nfiltbank, orderLPC):
    ...
    plt.grid()
    plt.legend((s1, s2, c1, c2), ('Ahmet','Emre','Ahmet centroids', 'Emre centroids'), scatterpoints = 1, loc = 'upper left')    
    plt.show()
