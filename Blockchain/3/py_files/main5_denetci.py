...
def blokekle():
    ...
    transaction= f"\"{musteri}\" id numaralı denetçi, \
\"{satici}\" id numaralı satıcıdan {yumurta} \
denetlendi."
...
musteri_id_label=Label(root,text="Denetçi ID:",pady=10)
