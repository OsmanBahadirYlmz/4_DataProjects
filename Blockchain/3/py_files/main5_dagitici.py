...
def blokekle():
    ...
    transaction= f"\"{musteri}\" id numaralı dağıtıcı, \
\"{satici}\" id numaralı satıcıdan {yumurta} alındı."
...
musteri_id_label=Label(root,text="Dağıtıcı ID:",pady=10)
